...
public class HeadDrops extends AbstractCraftBookMechanic {
    ...
    protected enum MobSkullType {
        ...
        CHICKEN("MHF_Chicken"),
        COD("__WalterWhite___"),
        COW("MHF_Cow"),
        DOLPHIN("CEO_of_Dolphins"),
        DONKEY("xloveless"),
        DROWNED("Loofda"),
        ...
        PHANTOM("Horus3"),
        PIG("MHF_Pig"),
        PIGLIN("Inconciousness"),
        PIGLIN_BRUTE("SrEstelles"),
        PILLAGER("Arcadde"),
        POLAR_BEAR("Polar_Bear"),
        PUFFERFISH("PicoreRE"),
        RABBIT("MHF_Rabbit"),
        RAVAGER("ValveInc"),
        SALMON("MapacheVolador"),
        SHEEP("MHF_Sheep"),
        SHULKER("MHF_Shulker"),
        SILVERFISH("AlexVMiner"),
        SKELETON_HORSE("Viriak"),
        SLIME("MHF_Slime"),
        SNOW_GOLEM("SNObeast"),
        SPIDER("MHF_Spider"),
        STRAY("bestfin"),
        ...
        SQUID("MHF_Squid"),
        TADPOLE("HugePeeBall"),
        TRADER_LLAMA("DashwDiamond"),
        TROPICAL_FISH("OG_Saumon"),
        TURTLE("zulw_park"),
        WARDEN("__Warden"),
        WANDERING_TRADER("MeGustaTuOllo"),
        WITCH("MHF_Witch"),
        WITHER("tygnouf"),
        WOLF("MHF_Wolf"),
        VEX("MHF_Vex"),
